...
$return_page2 = 'token_test1.php?token=ctc';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //$db = getDbInstance();
    $db->where("wallet_address", $_POST['address']);
    ...
    $data_to_send_logs['fee'] = 0; // $_POST['amount'] * 0.05; // 20.08.03
    ...
    if(!empty($transactionId)) {
        ...
        $data_to_store['fee_in_gcg'] = 0; // $_POST['amount'] * 0.05; // 20.08.03
                ...
                <div class=""><!-- panel -->
                    ...
                    <div id="main_content" class="panel-body">
                        ...
                        <div class="card">
                            ...
                            <div class="boxed bg--secondary boxed--lg boxed--border">
                                ...
                                <form class="form" action="set_transferpw_frm_sendTEST.php" method="post"  id="customer_form" enctype="multipart/form-data">
                    ...
                    <div class="modal fade" id="confirm_modal_box" role="dialog">
                        <div class="modal-dialog confirm_modal_box1">
                            <form action="set_transferpw_frm_sendTEST.php" method="POST">
