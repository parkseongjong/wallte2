...
<div id="bottom_fixed_menu" class="<?php echo $bottom_fixed_menu_c; ?>">
	<ul>
		<li>
			<a href="index.php" title="home" class="<?php echo $home_btn_class; ?>">
				<img src="images/icons/bmenu_home_<?php echo $home_btn_class; ?>.png" alt="home" />
				<p><?php echo !empty($langArr['send_sms_message6']) ? $langArr['send_sms_message6'] : 'Home'; ?></p>
			</a>
		</li>
		<li>
			<a href="coupon_list.php" title="coupon" class="<?php echo $coupon_btn_class; ?>">
				<img src="images/icons/bmenu_coupon_<?php echo $coupon_btn_class; ?>.png" alt="home" />
		...
		<li>
			<a href="javascript:;" title="exchange" onclick="goExchange()" class="off">
				<img src="images/icons/bmenu_exchange.png" alt="exchange" />
				<p><?php echo !empty($langArr['bottom_fixed_menu_bit_btn']) ? $langArr['bottom_fixed_menu_bit_btn'] : 'Exchange'; ?></p>
			</a>
		</li>
		<li>
			<a href="javascript:;" title="barrybarries" class="" onclick="goBarry()" class="off">
				<img src="images/icons/bmenu_market.png" alt="market" />
...
<div class="scroll_m">
	...
	<?php } ?>-->
	<p class="scroll_top_btn"><img src="images/icons/smenu_top.png" alt="top" /></p>
</div>
<?php } ?>

<?php include_once 'barcode_common.php'; ?>
  ...
  function changeLanguage(getThis){
    ...
    function goBarry() {
        $.ajax({
            ...
            success : function(resp){
                if (resp.msg) {
                    document.location.href = "https://barrybarries.kr/?ckey=" + resp.msg;
                } else {
