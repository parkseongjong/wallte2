...
<div id="login" class="login_input">
    ...
    <p>test hash sample: 56ae5317abc127a6c430d298259ce9fdde8937c80b8294af4686573ba294b8c2</p>
    <p>test device ID sample: test-test-01</p>
    <div class="login_logo"><!--<img src="images/eth_logo.png" alt="logo" />--><img src="images/logo3.png" alt="logo" /></div>
    <form class="form loginform" method="POST" action="authenticate_test1.php" name="form1">
        ...
        <div class="">
            ...
            <ul class="bottom">
                <li class="text1"><a  href="register_agree.php" title="register" ><?php echo !empty($langArr['register']) ? $langArr['register'] : "Register"; ?></a>&nbsp; | &nbsp;<a href="http://pf.kakao.com/_axkxaxis" title="customer center" target="_blank"><?php echo !empty($langArr['customer_center']) ? $langArr['customer_center'] : "Customer Center"; ?></a></li>
                ...
                <li class="text2">
                    <!--<a href="forgetpassword.php" title="forgot password"><?php echo !empty($langArr['login_text2']) ? $langArr['login_text2'] : "Reset Password"; ?></a>-->
...
<script>
    ...
    $(function () {
        <?php /*if($_SERVER['REMOTE_ADDR'] == '112.171.120.140' || $_SERVER['REMOTE_ADDR'] == '112.171.120.162'): ?>
			bsCommonAlert('test'+$('#dev_id').val()+$('#dev_id2').val()+$('#dev_id3').val()+$('#app_version').val());
		<?php endif */?>
