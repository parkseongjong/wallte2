...
<div id="register" class="login_input">
	...
	<form class="form loginform" method="POST" action="save_register_test1.php" >
		...
		<?php
			...
			<div><!-- class="panel-body"-->
				...
				<div class="form-group">
					<input type="password" id="psw"  pattern=".{6,}" title="Must contain at least 6 or more characters" name="passwd" class="input" required="required" placeholder="<?php echo !empty($langArr['password']) ? $langArr['password'] : "Password"; ?>">
				</div>
				
				<div class="form-group">
					<input type="password" id="confirm_psw"  pattern=".{6,}" title="Must contain at least 6 or more characters" name="cofirm_passwd" class="input" required="required" placeholder="<?php echo !empty($langArr['confirm_password']) ? $langArr['confirm_password'] : "Confirm Password"; ?>">
				</div>
				<div id="message">
