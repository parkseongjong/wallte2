...
if($search_string) {
    ...
    */
    ...
    $walletLogger->info('관리자 모드 > 등록 된 사용자 목록 > E-Pay 회원 목록 > 검색 /검색어:'.$search_string.'/검색 조건:'.$filter_col,['admin_id'=>$walletLoggerUtil->getAdminSession(),'user_id'=>0,'url'=>$walletLoggerUtil->getUrl(),'action'=>'S']);
}
else{
    $walletLogger->info('관리자 모드 > 등록 된 사용자 목록 > E-Pay 회원 목록 > 조회',['admin_id'=>$walletLoggerUtil->getAdminSession(),'user_id'=>0,'url'=>$walletLoggerUtil->getUrl(),'action'=>'S']);
}
if ( !empty($date1) ) {
...
<div class="row">
     <div class="col-lg-6">
            <h1 class="page-header"><?php echo !empty($langArr['admin_user_epay_list']) ? $langArr['admin_user_epay_list'] : "E-Pay Users List"; ?></h1>
        </div>
</div>
    ...
    <div class="well text-center filter-form">
        <form class="form form-inline" action="">
            ...
            <select name="filter_col" class="form-control">
				<option value="ectc" <?php if ( $filter_col == 'etoken_ectc') echo "selected"; ?>>E-CTC</option>
				<option value="etp3" <?php if ( $filter_col == 'etoken_etp3') echo "selected"; ?>>E-TP3</option>
				<option value="emc" <?php if ( $filter_col == 'etoken_emc') echo "selected"; ?>>E-MC</option>
				<option value="ekrw" <?php if ( $filter_col == 'etoken_ekrw') echo "selected"; ?>>E-KRW</option>
				<option value="eusdt" <?php if ( $filter_col == 'etoken_eusdt') echo "selected"; ?>>E-USDT</option>
				<option value="eeth" <?php if ( $filter_col == 'etoken_eeth') echo "selected"; ?>>E-ETH</option>
            </select>
