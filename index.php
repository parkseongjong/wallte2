                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" id="swiper-slide3">
                        ...
                        <ul class="index_token_block">
                            ...
                            <li class="token_block" id="hidden_tab">
                                <!--<a href="exchange_ectc.php" title="ctc">-->
                                <a href="#" onclick="no_open_page()" title="ctc">
                                    <!--                                <a href="javascript:;" onclick="view_message();">-->
                            ...
                            <li class="token_block" id="hidden_tab">
                                ...
                                <a href="#" onclick="no_open_page()" title="tp3">
                                    <!--                                <a href="javascript:;" onclick="view_message();">-->
                            ...
                            <li class="token_block" id="hidden_tab">
                                ...
                                <a href="#" onclick="no_open_page()" title="mc">
                                    <!--                                <a href="javascript:;" onclick="view_message();">-->
                            ...
                            <li class="token_block" id="hidden_tab">
                                ...
                                <a href="#" onclick="no_open_page()" title="usdt">
                                    <!--                                <a href="javascript:;" onclick="view_message();">-->
                            ...
                            <li class="token_block" id="hidden_tab">
                                ...
                                <a href="#" onclick="no_open_page()"title="eth">
                                    <!--                                <a href="javascript:;" onclick="view_message();">-->
