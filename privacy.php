...
&lt;(주)한가족몰&gt;('https://cybertronchain.com/wallet2')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br />
<br />
○ 본 방침은부터 2019년 7월 25일부터 시행됩니다.<br />
 <br />
1. 개인정보의 처리 목적 &lt;(주)한가족몰&gt;('https://cybertronchain.com/wallet2')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br />
가. 홈페이지 회원가입 및 관리<br />
...
4. 개인정보의 제3자 제공에 관한 사항<br />
 <br />
① &lt;(주)한가족몰는&gt;('http://https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br />
② &lt;(주)한가족몰는&gt;('http://https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br />
 <br />
 <br />
5. 개인정보처리 위탁<br />
 <br />
① &lt;(주한가족몰는&gt;('http://https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br />
 <br />
②  &lt;(주)한가족몰는&gt;('http://https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적ㆍ관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리ㆍ감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br />
 <br />
...
7. 처리하는 개인정보의 항목 작성 <br />
 <br />
① &lt;(주)한가족몰는&gt;('http://https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br />
1&lt;홈페이지 회원가입 및 관리&gt;<br />
- 필수항목 : 이메일, 휴대전화번호, 비밀번호 질문과 답, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록<br />
- 선택항목 : 자택주소, 자택전화번호<br />
 <br />
 <br /> 
8. 개인정보의 파기&lt;(주)한가족몰는&gt;('https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br />
-파기절차<br />
...
10. 개인정보 보호책임자 작성 <br />
 <br />
① &lt;(주)한가족몰는&gt;('https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2') 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br />
▶ 개인정보 보호책임자 <br />
성명 : 한백희<br />
직책 : 솔루션사업부서<br />
직급 : cs팀<br />
...
연락처 : 02-3489-3239, dmmall2020@gmail.com <br />
<br />
② 정보주체께서는 (주)한가족몰는&gt;('https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2') 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. &lt;(주)한가족몰는&gt;('http://https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2') 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br />
 <br />
 <br />
11. 개인정보 처리방침 변경 <br />
...
&lt;(주)한가족몰는&gt;('https://cybertronchain.com/wallet2'이하  'https://cybertronchain.com/wallet2')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신ㆍ점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.<br />
 <br />
5. 개인정보의 암호화<br />
