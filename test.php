<?php 
/* $getFeeData = file_get_contents("https://ethgasstation.info/api/ethgasAPI.json");
$getFeeData = json_decode($getFeeData,true);
echo $getAverage = dechex($getFeeData['average']/10);
...
$web3 = new Web3('http://195.201.168.34:8545/');
$eth = $web3->eth;



    // send transaction
    $eth->getTransactionCount('0xcea66e2f92e8511765bc1e2a247c352a7c84e895','pending', function ($err, $transaction) use ($eth) {
        if ($err !== null) {
        ...
        <div class="col-lg-4 col-md-4">
            <div class="panel panel-primary" style="border-color:#ffd602;">
                <div class="panel-heading" style="background:#ffd602;height:130px;">
                    <div class="row" style="color:#333;">
                        <div class="col-xs-3">
                            <img src="https://cybertronchain.com/wallet2/images/1321_64.png" height="70px">
                        </div>
                        <div class="col-xs-9 text-right">
