...
class AttendanceModel extends BaseModel
{
    ...
    public function getAttendInfo($userId)
    {
        ...
        return $this->walletDb->createQueryBuilder()
            ->select('*,(SELECT count(0) FROM tb_user_attendance WHERE ad_user_id = a.ad_user_id) as cnt')
            ->from('tb_user_attendance', 'a')
    ...
    public function addAttendance($userId, $data): string
    {
        ...
        $this->builder->insert('tb_user_attendance');
        $this->dataBind($data);
