...
class Info{
    ...
    //protected $new_server_ip = 'http://3.34.253.74';
    //protected $new_server_ip_notProtocol = '3.34.253.74';

    protected $new_server_ip = 'http://195.201.168.34';
    protected $new_server_ip_notProtocol = '195.201.168.34';
