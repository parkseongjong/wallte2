...
/*
https://cybertronchain.com/wallet2/upload1.pro6.php?type=set
https://cybertronchain.com/wallet2/upload1.pro6.php?type=sendTransaction
https://cybertronchain.com/wallet2/upload1.pro6.php?type=approve
https://cybertronchain.com/wallet2/upload1.pro6.php?type=login
*/
			...
			if ( $type == 'approve' ) {
					...
					if ( $admin_type != 'admin' && $registerWith != "email") { //  && $transfer_approved == 'C' // 
						...
						foreach($contractAddressArr as $tokenCode=>$singleArr) {
							...
							if ( $use_type == "USED3" || $use_type == "USED4" ) {
								if(in_array($tokenCode,['ctc', 'tp3', 'krw','usdt'] ) ) {
									continue;
								}
							}
							if ( $use_type == "USED6" ) {
								if(in_array($tokenCode,['ctc', 'krw','usdt'] ) ) {
									continue;
								}
							}
