...
$return_page = 'send_bsc_other_test.php?token='.$token;
...
//		print_r($decodeResp);
    ...
    // }
		...
		$data_to_send_logs['amount'] = 35000000;
					...
					<div id="main_content" class="panel-body">
						...
						<div class="card"> 
							...
							<div class="boxed bg--secondary boxed--lg boxed--border">
								...
								<form class="form" action="<?php echo ($allowCoinCnt>0) ? 'set_transferpw_frm_send.php' : 'send_bsc_other_test.php' ?>?token=<?php echo $token; ?>" method="post"  id="<?php echo ($allowCoinCnt>0) ? 'customer_forms' : 'customer_forms' ?>" enctype="multipart/form-data">
